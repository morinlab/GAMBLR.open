...
Convenience function for loading coding Simple Somatic Mutations (SSM)
from the bundled data
[GAMBLR.data::sample_data](https://rdrr.io/pkg/GAMBLR.data/man/sample_data.html).
...
- include_silent:
  ...
  coding mutations. Default is TRUE.
...
This "bare bones" function was developed to retrieve coding SSM calls
for non-GSC-users. Effectively retrieve coding SSM calls. Multiple
